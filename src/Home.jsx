  ...
  return (
    <div className="container mx-auto flex flex-col justify-center items-center min-h-[calc(100vh-150px)]">
      ...
      <div className="flex gap-40 justify-center text-3xl sm:text-4xl mt-4">
        <Link to={"/game/easy"} className="hover:bg-yellow-800/50 rounded-2xl px-5 text-center">Easy</Link>
        <Link to={"/game/normal"} className="hover:bg-yellow-800/50 rounded-2xl px-5 text-center">Normal</Link>
      </div>
