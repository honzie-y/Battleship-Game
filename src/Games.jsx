...
const Games = () => {
  ...
  return (
    <div className='flex flex-col items-center justify-center min-h-[calc(100vh-250px)]'>
        {path === "/easy" && <h1 className='mt-3 font-barrio text-2xl sm:text-3xl bg-yellow-800 w-fit px-3'>Easy Mode</h1>}
        {path === "/normal" && <h1 className='mt-3 font-barrio text-2xl sm:text-3xl bg-yellow-800 w-fit px-3'>Normal Mode</h1>}
